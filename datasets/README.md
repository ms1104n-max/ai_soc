...
|---------|--------------|----------------|---------------------|
| CICIDS2017 | Yes | Check terms | Yes |
| UNSW-NB15 | Yes | No | Yes |
| CICIoT2023 | Yes | Check terms | Yes |
| LogHub | Yes | Yes (OSS) | Yes |
...
This project is maintained by Sai Nikhil Mattapalli, an AI/ML Engineer with experience in building and deploying scalable Machine Learning and Generative AI solutions. With a focus on end-to-end ML pipelines and security analytics, Sai oversees the data acquisition and preprocessing workflows for this repository.

For technical support or inquiries regarding these datasets, please open an issue on GitHub or contact:
