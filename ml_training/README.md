...
```
ml_training/
â”œâ”€â”€ train_ids_model.py      # Complete training pipeline
â”œâ”€â”€ inference_api.py         # FastAPI inference endpoint
â”œâ”€â”€ requirements.txt         # Python dependencies
â””â”€â”€ README.md               # This file

models/                     # Trained models (generated)
â”œâ”€â”€ random_forest_ids.pkl
â”œâ”€â”€ xgboost_ids.pkl
â”œâ”€â”€ decision_tree_ids.pkl
â”œâ”€â”€ scaler.pkl
...
â”œâ”€â”€ Monday-WorkingHours.csv
â”œâ”€â”€ Tuesday-WorkingHours.csv
â”œâ”€â”€ Wednesday-WorkingHours.csv
â”œâ”€â”€ Thursday-WorkingHours.csv
â””â”€â”€ Friday-WorkingHours.csv
```
...
Found 5 CSV files:
  Loading: Monday-WorkingHours.csv... âœ“ 371,749 records
  Loading: Tuesday-WorkingHours.csv... âœ“ 322,003 records
  ...
  Total: 2,100,814 records

PREPROCESSING
1. Removing non-predictive features... âœ“ Dropped 6 columns
2. Handling missing values... âœ“ Removed 0 missing values
3. Replacing infinite values... âœ“ Replaced 1,234 infinite values
4. Processing labels... âœ“ Binary classification (BENIGN vs ATTACK)
5. Encoding labels... âœ“ Encoded 2 classes
6. Scaling features... âœ“ Scaled 78 features

TRAINING: RANDOM FOREST
Training on 1,680,651 samples... âœ“ Completed in 127.45s
...
|--------|--------|--------|
| Accuracy | >99% | âœ“ ACHIEVED |
| False Positive Rate | <1% | âœ“ ACHIEVED |
| Inference Latency | <100ms | âœ“ ACHIEVED |
| Model Size | <500MB | âœ“ ACHIEVED |
...
This project is actively maintained by Sai Nikhil Mattapalli, an AI/ML Engineer with 5 years of experience building and deploying scalable Machine Learning solutions. Proficient in Python, Scikit-learn, XGBoost, and FastAPI, Sai Nikhil focuses on creating robust and efficient ML pipelines for real-time security applications.

## Contact

**Maintainer:** Sai Nikhil Mattapalli
**Email:** ms1104n@gmail.com
**GitHub:** [SaiNikhilMattapalli](https://github.com/SaiNikhilMattapalli)
**LinkedIn:** [Sai Nikhil Mattapalli](https://www.linkedin.com/in/sai-nikhil-mattapalli-profile/)
**Mission:** OPERATION ML-BASELINE
